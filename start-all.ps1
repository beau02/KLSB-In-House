...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location -Path \"$PSScriptRoot\\backend\"; Write-Host 'Backend Server' -ForegroundColor Green; npm run dev"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location -Path \"$PSScriptRoot\\web-frontend\"; Write-Host 'Web Frontend' -ForegroundColor Green; npm run dev"

# Start Mobile App
Write-Host "Starting Mobile App..." -ForegroundColor Cyan
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location -Path \"$PSScriptRoot\\mobile-app\"; Write-Host 'Mobile App' -ForegroundColor Green; npm start"
